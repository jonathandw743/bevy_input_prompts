...
pub fn degeneracy_ordering(graph: &[FixedBitSet], n: usize) -> Vec<usize>
{
...
pub fn greedy_coloring(graph: &[FixedBitSet], order: &[usize], n: usize) -> (usize, Vec<usize>)
{
...
pub fn graph_coloring(graph: &[FixedBitSet], n: usize) -> (usize, Vec<usize>)
{
